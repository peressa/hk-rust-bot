...
module.exports = {
    ...
    getSmartSwitchEmbed: function (client, guildId, serverId, entityId) {
    ...
    getServerEmbed: async function (client, guildId, serverId) {
        const instance = client.getInstance(guildId);
        ...
        if (server.battlemetricsId !== null) {
            ...
            if (bmInstance) {
                ...
                description += (bmInstance.streamerMode ? client.intlGet(guildId, 'onCap') :
        ...
        return module.exports.getEmbed({
            ...
            fields: [{
                ...
                value: `\`${server.connect === null ?
                    client.intlGet(guildId, 'unavailable') : server.connect}\``,
                inline: true
            },
            {
    ...
    getTrackerEmbed: function (client, guildId, trackerId) {
        const instance = client.getInstance(guildId);
        ...
        description += (!bmInstance ? Constants.NOT_FOUND_EMOJI : (bmInstance.streamerMode ?
            client.intlGet(guildId, 'onCap') : client.intlGet(guildId, 'offCap'))) + '\n';
        ...
        for (let i = 0; i < (fieldIndex + 1); i++) {
            ...
            fields.push({
                name: i === 0 ? `__${client.intlGet(guildId, 'steamId')}__ /\n` +
    ...
    getSmartAlarmEmbed: function (client, guildId, serverId, entityId) {
        const instance = client.getInstance(guildId);
    ...
    getStorageMonitorEmbed: function (client, guildId, serverId, entityId) {
        const instance = client.getInstance(guildId);
        ...
        description += `\n**${client.intlGet(guildId, 'type')}** ` +
            `\`${entity.type !== null ? client.intlGet(guildId, entity.type) :
                client.intlGet(guildId, 'unknown')}\``;
        ...
        if (entity.type === 'toolCupboard') {
            ...
            if (seconds === 0) {
                ...
                instance.serverList[serverId].storageMonitors[entityId].upkeep =
                    client.intlGet(guildId, 'decayingCap');
            }
            else {
    ...
    getSmartSwitchGroupEmbed: function (client, guildId, serverId, groupId) {
        const instance = client.getInstance(guildId);
    ...
    getNotFoundSmartDeviceEmbed: function (client, guildId, serverId, entityId, type) {
        const instance = client.getInstance(guildId);
    ...
    getStorageMonitorRecycleEmbed: function (client, guildId, serverId, entityId, items) {
        const instance = client.getInstance(guildId);
        const entity = instance.serverList[serverId].storageMonitors[entityId];
        const grid = entity.location !== null ? ` (${entity.location})` : '';
        ...
        const embed = module.exports.getEmbed({
            ...
            description: `**${client.intlGet(guildId, 'name')}** ` +
                `\`${entity.name}${grid}\`\n**ID** \`${entityId}\``
        });
    ...
    getDecayingNotificationEmbed: function (client, guildId, serverId, entityId) {
        const instance = client.getInstance(guildId);
        const entity = instance.serverList[serverId].storageMonitors[entityId];
        const grid = entity.location !== null ? ` (${entity.location})` : '';
    ...
    getStorageMonitorDisconnectNotificationEmbed: function (client, guildId, serverId, entityId) {
        const instance = client.getInstance(guildId);
        const entity = instance.serverList[serverId].storageMonitors[entityId];
        const grid = entity.location !== null ? ` (${entity.location})` : '';
    ...
    getNewsEmbed: function (client, guildId, data) {
        return module.exports.getEmbed({
    ...
    getTeamLoginEmbed: function (client, guildId, body, png) {
        return module.exports.getEmbed({
    ...
    getAlarmEmbed: function (client, guildId, serverId, entityId) {
        const instance = client.getInstance(guildId);
        const entity = instance.serverList[serverId].alarms[entityId];
        const grid = entity.location !== null ? ` (${entity.location})` : '';
    ...
    getEventEmbed: function (client, guildId, serverId, text, image, color = Constants.COLOR_DEFAULT) {
        const instance = client.getInstance(guildId);
        const server = instance.serverList[serverId];
        return module.exports.getEmbed({
            color: color,
    ...
    getServerChangedStateEmbed: function (client, guildId, serverId, state) {
        const instance = client.getInstance(guildId);
        const server = instance.serverList[serverId];
        return module.exports.getEmbed({
    ...
    getServerWipeDetectedEmbed: function (client, guildId, serverId) {
        const instance = client.getInstance(guildId);
        const server = instance.serverList[serverId];
        return module.exports.getEmbed({
            color: Constants.COLOR_DEFAULT,
    ...
    getServerConnectionInvalidEmbed: function (client, guildId, serverId) {
        const instance = client.getInstance(guildId);
        const server = instance.serverList[serverId];
        return module.exports.getEmbed({
            color: Constants.COLOR_INACTIVE,
    ...
    getActivityNotificationEmbed: function (client, guildId, serverId, color, text, steamId, png, title = null) {
        const instance = client.getInstance(guildId);
