    ...
    <div className="premium-card animate-fade-in" style={{ 
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <div style={{ textAlign: 'right' }}>
           <div style={{ fontSize: '0.7rem', color: '#22c55e', fontWeight: 900, fontFamily: 'var(--font-barlow)', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
      ...
      <div>
        <h3 style={{ fontSize: '1.75rem', fontFamily: 'var(--font-barlow)', marginBottom: '0.25rem', letterSpacing: '0.02em', lineHeight: 1.1 }}>
          {server.name}
        </h3>
      ...
      <div style={{ marginTop: 'auto', borderTop: '1px solid var(--border)', paddingTop: '1.5rem' }}>
        <Link href={`/war-room/${server.id}`} className="btn-primary" style={{ width: '100%', justifyContent: 'center', fontSize: '1rem' }}>
          Panel de Control <ChevronRight size={20} />
        </Link>
      </div>
    </div>
  );
